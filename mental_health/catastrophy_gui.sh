...
#this is a GUI bash script to help the user deal with an acute anxiety attack

# Check if Zenity is installed
if ! command -v zenity &> /dev/null
then
    echo "Zenity is required but not installed. Please install Zenity and run the script again."
    exit 1
fi
